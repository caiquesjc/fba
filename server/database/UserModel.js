...
const registerUser = (body) => {
  return new Promise(function (resolve, reject) {
    ...
    Connection.query(
      `INSERT INTO "user" (use_name, use_age, use_email, use_telephone, use_password, use_is_admin, use_nickname) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`,
...
const updateUser = (body) => {
  return new Promise(function (resolve, reject) {
    ...
    Connection.query(
      'UPDATE "user" SET use_name=$1, use_nickname=$2, use_email=$3, use_telephone=$4, use_password=$5 WHERE use_id=$6 RETURNING *',
      [use_name, use_nickname, use_email, use_telephone, use_password, use_id],
      (error, results) => {
