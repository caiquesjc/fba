            ...
            (
             ...
             DELETE CASCADE
                   ...
                   DELETE CASCADE,
                          ...
                          FOREIGN KEY (fk_cla_id) REFERENCES "class"(cla_id)
                   ON
                   DELETE CASCADE,
                          fk_use_id INT NOT NULL,
                          FOREIGN KEY (fk_use_id) REFERENCES "user"(use_id)
                   ON
                   DELETE CASCADE
                   );INSERT INTO class
                        (
...
CREATE OR replace FUNCTION check_password(fun_use_email_or_nick TEXT,
                                                      fun_use_pass TEXT) returns BOOLEAN
            AS
              $$
              DECLARE
                passed BOOLEAN;
              ...
              BEGIN
                ...
                (
                       SELECT use_id
                       FROM   "user"
                       WHERE  use_email = fun_use_email_or_nick
                       OR     use_nickname = fun_use_email_or_nick limit 1);
